...
export function TeamManagement() {
  ...
  const { teams, loading, error, createTeam, updateTeam, deleteTeam, toggleTeamStatus, uploadTeamAvatar, removeTeamAvatar, refetch: refetchTeams } = useTeams()
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <Button onClick={() => setIsCreateDialogOpen(true)} className="sm:hidden w-full">
